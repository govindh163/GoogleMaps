...
class TopSnapSheet extends StatefulWidget {
  @override
  _TopSnapSheetState createState() => _TopSnapSheetState();
}

class _TopSnapSheetState extends State<TopSnapSheet> with SingleTickerProviderStateMixin{
