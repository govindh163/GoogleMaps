...
class UserGuide extends StatelessWidget {
  ...
  Widget build(BuildContext context) => MaterialApp(
    ...
    home: const FeatureDiscovery(
      child: Guidemanual(title: 'Flutter Feature Discovery'),
    ),
  );
}

class Guidemanual extends StatefulWidget {
  const Guidemanual({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _GuidemanualState createState() => _GuidemanualState();
}

class _GuidemanualState extends State<Guidemanual> {
  @override
